...
namespace TestProject.BusinessLayer
{
    ...
    public class CommandInvoker
    {
        ...
        /// <returns></returns>
        public static TResult InvokeCommand<TRequest, TResult>(TRequest command) where TRequest:ICommand
        ...
        {
            if (typeof (TRequest) == typeof (BikeSaveCommand))
            {
                return new BikeSaveCommandHandler();
            }
            //
            return null;
        }
